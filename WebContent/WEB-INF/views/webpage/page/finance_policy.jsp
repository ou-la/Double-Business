...
<body>
	...
	<div class="container" style="margin-top: 2rem;">
		<a href="#">
	      ...
	      <div class="col-xs-4 lft_img">
	      	<img src="${jpath}/static/imgs/929.png"">
	      </div>
	...
	<div class="container" style="margin-top: 2rem;">
		<a href="#">
	   	<div class="row bian">
	      <div class="col-xs-4 lft_img">
	      	<img src="${jpath}/static/imgs/lijiacheng.png"">
	      </div>
	      <div class="col-xs-8 row_line">
	      	<div class="row hepin">
	      		wowo便利超市
	...
	<div class="container" style="margin-top: 2rem;">
		<a href="#">
	   	<div class="row bian">
	      <div class="col-xs-4 lft_img">
	      	<img src="${jpath}/static/imgs/lianhome.png"">
	      </div>
	      <div class="col-xs-8 row_line">
	      	<div class="row hepin">
	      		wowo便利超市
	...
	<div class="container" style="margin-top: 2rem;">
		<a href="#">
	   	<div class="row bian">
	      <div class="col-xs-4 lft_img">
	      	<img src="${jpath}/static/imgs/dichan.png"">
	      </div>
	      <div class="col-xs-8 row_line">
	      	<div class="row hepin">
	      		wowo便利超市
	...
	<div class="container" style="margin-top: 2rem;">
		<a href="#">
	   	<div class="row bian">
	      <div class="col-xs-4 lft_img">
	      	<img src="${jpath}/static/imgs/930.png"">
	      </div>
	      <div class="col-xs-8 row_line">
	      	<div class="row hepin">
	      		wowo便利超市
