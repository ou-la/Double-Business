	...
	<div class="col-xs-12">
		...
		<form class="form-horizontal" id="stuForm" role="form">
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" name="proid" id="proid" value="${Cp.protitle}" placeholder="proid" class="col-xs-10 col-sm-5" />
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" name="protitle" id="protitle" value="${Cp.timelimit}" placeholder="protitle" class="col-xs-10 col-sm-5" />
				</div>
			</div>
...
$(function(){
	...
	$("#subBtn").click(function(){
		...
		$.post("${jpath}/cp/updateCp",jsonFroms,function(data){
